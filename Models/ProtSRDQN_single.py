...
class ProtSRDQN_single(object):
    ...
    def _build_network(self):
        ...
        # Avoid less than zero
        self.label = tf.math.add(self.label, 10)
    ...
    def _prototype_layer(self, tensor, frequency_set, prototype_size, embedding_size, q_value, name, diversity1=False, diversity2=True):
        ...
        if diversity2:
            ...
            diversity_loss += tf.reduce_mean(tf.math.maximum(tf.zeros_like(prototype_distance), prototype_distance - 0.1 * tf.ones_like(prototype_distance)))
